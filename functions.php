...
function cpt_venues() {
	...
	$args = array(
		...
		'description'           => __( 'Venues of Kawai Purapura', 'text_domain' ),
		'labels'                => $labels,
		'taxonomies'            => array( 'category' ),
		'hierarchical'          => true,
		'public'                => true,
...
if( function_exists('acf_add_options_page') ) {	
	...
	acf_add_options_sub_page(array(
		'page_title' 	=> 'Venues Page Settings',
		'menu_title' 	=> 'Venues Settings',
		'parent_slug' 	=> 'edit.php?post_type=venues',
	));
	acf_add_options_sub_page(array(
